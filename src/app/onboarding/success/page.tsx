    ...
    <main className="relative max-w-2xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
      ...
      <div className="relative text-center">
        ...
        <motion.div
          ...
          className="mx-auto w-24 h-24 rounded-full bg-gradient-to-br from-brand-teal to-brand-sky flex items-center justify-center shadow-[0_0_60px_rgba(107,160,172,0.5)]"
        >
          <motion.span
                    ...
                    <span
                      className={cn(
                        ...
                        last
                          ...
                          : "bg-[rgba(107,160,172,0.12)] text-accent border-[rgba(107,160,172,0.25)]"
                      )}
                    >
                      <Icon className="w-4.5 h-4.5" />
                    </span>
                    {!last && <span className="w-px flex-1 bg-[rgba(107,160,172,0.25)] mt-1.5" />}
                  </div>
                  <div className="pb-1">
