    ...
    <>
        ...
        {plans.map((plan) => (
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-[rgba(27,27,30,0.04)] rounded-xl p-3">
      ...
      >
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="sm:col-span-2 rounded-xl bg-[rgba(27,27,30,0.08)] border border-[var(--accent)]/30 p-3 flex items-center justify-between text-sm">
          ...
          <div className="rounded-xl bg-[rgba(27,27,30,0.04)] p-3 text-xs text-muted flex items-center">
          ...
          <div className="sm:col-span-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              {CAPABILITY_META.map((c) => (
                <label
                  key={c.key}
                  className="flex items-start gap-2.5 text-sm cursor-pointer rounded-xl bg-[rgba(27,27,30,0.04)] p-3"
                >
                  <input
                    type="checkbox"
                    className="mt-0.5"
