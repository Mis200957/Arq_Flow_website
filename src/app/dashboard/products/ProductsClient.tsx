        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {products.map((p) => (
            <div key={p.id} className={cn("card p-4 card-hover", !p.available && "opacity-60")}>
              <div className="aspect-square rounded-xl overflow-hidden mb-3 bg-[rgba(27,27,30,0.05)] flex items-center justify-center">
                {p.image_url ? (
        ...
        <div className="space-y-4">
          ...
          <Field label={t.image}>
            <div className="flex items-center gap-3">
              <div className="w-20 h-20 rounded-xl overflow-hidden bg-[rgba(27,27,30,0.05)] flex items-center justify-center shrink-0 border border-[var(--border)]">
                {form.image_url ? (
