      ...
      <div className="card p-6">
        ...
        <div className="mt-4 space-y-2">
          {files.length === 0 ? (
            ...
            <div key={f.id} className="flex items-center gap-3 p-2.5 rounded-xl bg-[rgba(27,27,30,0.04)]">
        ...
        <div className="grid sm:grid-cols-2 gap-3">
          {OPS.map(({ action, Icon }) => (
            <button key={action} onClick={() => runJob(action)} disabled={busy === action}
              ...
              <div className="w-9 h-9 rounded-lg bg-[rgba(27,27,30,0.12)] text-accent flex items-center justify-center shrink-0">
