      ...
      {usage && (
        <div className="card p-5">
          ...
          <div className="space-y-2">
            ...
            <div className="h-3 rounded-full bg-[rgba(27,27,30,0.1)] overflow-hidden">
              ...
              <div className="grid grid-cols-3 gap-2">
                {(Object.keys(accounts) as Channel[]).map((ch) => (
                  <button key={ch} onClick={() => setMethod(ch)}
                    className={cn("rounded-xl border p-3 text-center text-sm transition", method === ch ? "border-[var(--accent)] bg-[rgba(27,27,30,0.1)]" : "border-[var(--border)]")}>
