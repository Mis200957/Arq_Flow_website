      ...
      <div className="card p-5">
        ...
        <ResponsiveContainer width="100%" height={220}>
          <AreaChart data={dailyData} margin={{ left: -20, right: 8, top: 4 }}>
            ...
            <CartesianGrid strokeDasharray="3 3" stroke="rgba(44,76,69,0.06)" vertical={false} />
        ...
        {monthlyData.length === 0 ? (
          ...
          <ResponsiveContainer width="100%" height={200}>
            <BarChart data={monthlyData} margin={{ left: -20, right: 8 }} barSize={28}>
              ...
              <YAxis tick={{ fill: "var(--fg-muted)", fontSize: 11 }} axisLine={false} tickLine={false} allowDecimals={false} />
              <Tooltip contentStyle={{ background: "var(--bg-solid)", border: "1px solid var(--border)", borderRadius: "0.75rem", color: "var(--fg)" }} cursor={{ fill: "rgba(44,76,69,0.05)" }} />
