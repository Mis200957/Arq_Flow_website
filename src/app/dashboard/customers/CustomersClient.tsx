        ...
        <div className="flex flex-wrap gap-1">
          {tagFilter && (
            <button
              ...
              className="flex items-center gap-1 text-xs px-2 py-1.5 rounded-full bg-[rgba(184,144,99,0.15)] text-accent border border-[var(--accent)]"
            >
              ...
              <tbody>
                {filtered.map((c) => (
                  <>
                    <tr
                      key={c.id}
                      className="border-b border-[var(--border)] hover:bg-[rgba(14,32,56,0.04)] cursor-pointer"
