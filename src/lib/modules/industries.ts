...
export const INDUSTRY_TEMPLATES: Record<string, IndustryTemplate> = {
  ...
  restaurant: {
    ...
    modules: ["orders", "products", "categories", "delivery", "promotions"],
  ...
  ecommerce: {
    ...
    icon: "ShoppingBag",
    modules: ["products", "orders", "inventory", "categories", "coupons"],
    hidden: ["services"],
    quickActions: ["products", "orders", "knowledge-base", "conversations"],
  ...
  store: {
    ...
    icon: "Store",
    modules: ["products", "orders", "inventory", "categories"],
    hidden: ["services"],
